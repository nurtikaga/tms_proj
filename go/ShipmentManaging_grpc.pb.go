...
const (
	ShipmentService_CreateShipment_FullMethodName = "/tmsmanagerpb.v1.ShipmentService/CreateShipment"
	ShipmentService_GetShipment_FullMethodName    = "/tmsmanagerpb.v1.ShipmentService/GetShipment"
	ShipmentService_AddEvent_FullMethodName       = "/tmsmanagerpb.v1.ShipmentService/AddEvent"
	ShipmentService_GetHistory_FullMethodName     = "/tmsmanagerpb.v1.ShipmentService/GetHistory"
)
...
type ShipmentServiceClient interface {
	...
	AddEvent(ctx context.Context, in *AddEventRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *shipmentServiceClient) AddEvent(ctx context.Context, in *AddEventRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *shipmentServiceClient) GetHistory(ctx context.Context, in *GetHistoryRequest, opts ...grpc.CallOption) (*HistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HistoryResponse)
	err := c.cc.Invoke(ctx, ShipmentService_GetHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShipmentServiceServer interface {
	...
	AddEvent(context.Context, *AddEventRequest) (*emptypb.Empty, error)
...
func (UnimplementedShipmentServiceServer) AddEvent(context.Context, *AddEventRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddEvent not implemented")
}
func (UnimplementedShipmentServiceServer) GetHistory(context.Context, *GetHistoryRequest) (*HistoryResponse, error) {
...
func _ShipmentService_GetHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShipmentServiceServer).GetHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShipmentService_GetHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShipmentServiceServer).GetHistory(ctx, req.(*GetHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShipmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tmsmanagerpb.v1.ShipmentService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ShipmentService_GetHistory_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "ShipmentManaging.proto",
}
